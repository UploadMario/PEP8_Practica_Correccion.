"""Este módulo contiene una clase CalculadoraMCM para calcular
el Mínimo Común Múltiplo (MCM) de dos números."""
class CalculadoraMCM:
    """Clase para calcular el Mínimo Común Múltiplo (MCM) de dos números."""
    def __init__(self):
        pass
